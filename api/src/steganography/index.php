...
<form name="steggerForm" method="post" action="<?php echo($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
  ...
  <blockquote>
    ...
    <h2>O</h2>
    <strong>Ingresa la url de una imagen:</strong><br />
    <input type="text" name="imageURL" size="40" />
  </blockquote>

  <blockquote>
    <strong>Ingresa el password para cifrar la info:</strong><br />
    <input type="text" name="key" size="40" />
  </blockquote>

  <blockquote>
    <strong>Escribe el mensaje a cifrar:</strong><br />
    <textarea name="secretMessage" rows="8" cols="90"></textarea>
  </blockquote>

  <input type="submit" name="submit" value="Enviar" /><input type="reset" name="reset" value="Cancelar" />
</form>
</blockquote>
</body>
</html>
